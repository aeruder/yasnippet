...
-  *Note*: In addition to the questions and answers presented here,
  you might also with to visit the list of [[https://github.com/joaotavora/yasnippet/issues?q=is%3Aissue+is%3Aclosed+label%3Asupport][solved support issues]] in
